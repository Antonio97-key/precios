...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://iejgnxhqivhqzjftzmmi.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImllamdueGhxaXZocXpqZnR6bW1pIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE3MTU3NjYsImV4cCI6MjA4NzI5MTc2Nn0.gMCgY3C5ImaDX8fhj5X7W09iCOIk0EbRbKhkknd_o3k");
...
async function saveTrackingAction(product, email, targetPrice) {
    try {
        ...
        const { data: existingProduct, error: selectError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('productos').select('id').eq('url', product.url).single();
        let productId = existingProduct?.id;
        if (!productId) {
            // No existe, crearlo
            const { data: newProduct, error: insertProdError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('productos').insert({
                url: product.url,
                nombre: product.name,
        ...
        const { error: trackError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('rastreos').insert({
...
//# sourceMappingURL=_fb7db33b._.js.map