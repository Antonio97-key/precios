...
import { Search, ShoppingBag, BellRing, TrendingDown, Loader2, CheckCircle2, Clock } from "lucide-react";
      ...
      <nav className="border-b border-slate-800/60 bg-slate-950/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" asChild className="text-slate-300 hover:text-indigo-400 transition-colors">
              <Link href="/admin/dashboard">Admin</Link>
            </Button>
            <Button variant="ghost" asChild className="text-slate-300 hover:text-white">
              <Link href="/rastreos">Mis Rastros</Link>
            </Button>
              ...
              <Card key={idx} className="bg-slate-900/50 border-slate-800 text-white hover:bg-slate-900 transition-colors group">
                ...
                <CardContent className="p-5">
                  <div className="flex items-center gap-1.5 mb-2">
                    <div className="flex items-center gap-1 bg-green-500/10 text-green-400 text-[10px] font-bold px-1.5 py-0.5 rounded border border-green-500/20">
                      <CheckCircle2 className="w-3 h-3" />
                      VERACIDAD GARANTIZADA
                    </div>
                    <div className="flex items-center gap-1 bg-slate-800 text-slate-400 text-[10px] px-1.5 py-0.5 rounded border border-slate-700">
