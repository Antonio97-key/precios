...
**Descripción: Testing, aseguramiento de calidad y validación**

 

**DOCUMENTO DE OPERACIONES Y GUÍA COMPLETA DE EJECUCIÓN**

Para: QA/Testing Agents en Antigravity
...
Stack Principal: Jest, Cypress, Selenium

## **1.2 Propósito Core**

Asegurar que la aplicación funciona como se espera antes de llegar a usuarios.
...
·         Realizar regresión testing

·         Asegurar coverage y calidad
...
Típicamente recibes: Features from developers, Requirements
...
·         ⊠ Deployment (si hay bugs critical)
...
## **Problema \#1: Flaky tests failing randomly**

**Síntomas: Tests pass/fail inconsistently**

Causa posible: TBD

**Solución: Fix race conditions, use waits**

Prevención: Better test structure, mocking
